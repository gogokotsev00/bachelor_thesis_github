...
%###################################################################################
\section{Motivation}
In recent times, the amount of interest in a cooperative environment for autonomous vehicles and infrastructure has increased and there are many researches on this topic \cite{ cvis_article_two, cvis_article_one}. Its main goal is to increase safety, decrease number of accidents and improve efficiency of city traffic. In order to achieve this it must be guaranteed that the self-steering vehicles are aware of their surroundings during the whole ride.

Nowadays, the cars with the highest level of autonomy rely on a combination of sensors like radar, Light Detection and Ranging (LiDAR) and camera systems to be able to perceive other participants in the traffic. However, on-board sensors have their drawbacks like limited visibility and decreased field of perception. Thus, the use of stationary sensors in a city infrastructure is beneficial for providing reliable and accurate information. Moreover, placement of sensors in the road area expands significantly the vehicle's range of view and contributes to safer and congestion-free roads. Unlike other sensors, cameras are cheaper and much easier to maintain. Another advantage is that they are capable of seeing the world like a human being would do, which is of utmost importance in object detection algorithms. The highly researched camera technology and its features are main reasons for this thesis to focus on its use for aiding mobility.

Real-world experiments for investigating an optimal sensor placement should be planned precisely and always require careful preparation because of various factors that can impact the results. In addition, conducting tests in the real world results in more costs and effort to reproduce a specific scenario. For the purpose of reducing costs and considering a greater range of camera positioning options, this work relies on the 3D autonomous driving simulator Carla\footnote{\url{https://carla.org/}, visited on 13/11/2022}. It is used for generating simulated data for different camera placements, which is then evaluated and the results are summarized.
