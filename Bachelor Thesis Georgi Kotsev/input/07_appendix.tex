...
\begin{figure} [h!]
    \centering
    \subfloat[Mercedes Sprinter]{\includegraphics[width=0.4\linewidth]{images/mercedes_sprinter.png}\label{fig:mercedes_sprinter}}
    \hfill
    \subfloat[Seat Leon]{\includegraphics[width=0.4\linewidth]{images/seat_leon.png}\label{fig:seat_leon}}
    \caption{Test vehicles part 1}
\end{figure}

\begin{figure} [h!]
    \centering
    \subfloat[Ambulance]{\includegraphics[width=0.4\textwidth]{images/ambulance.png}\label{fig:ambulance}}
    \hfill
    \subfloat[Jeep Wrangler Rubicon]{\includegraphics[width=0.4\textwidth]{images/jeep_wrangler_rubicon.png}\label{fig:jeep_wrangler}}
    \caption{Test vehicles part 2}
\end{figure}
