...
\begin{figure} [h!]
  \centering
  \subfloat[Occlusion from camera's point of view]{\includegraphics[width=0.57\textwidth]{images/camera_view_occlusion.jpg}}
  \hfill
  \subfloat[Occlusion from side point of view]{\includegraphics[width=0.43\textwidth]{images/different_view_occlusion.jpg}}
